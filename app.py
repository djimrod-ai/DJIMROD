...
def obtener_noticias_rss(keywords):
    ...
    if noticias_coincidentes:
        ...
        return todas_las_recientes[:20], "Modo Radar ( la actualidad general)"
...
with tab1:
    ...
    modo = st.radio("Selecciona el motor de búsqueda:", ["Instantánea (RSS Feeds)", "Global (NewsAPI)"], index=0, horizontal=True)
